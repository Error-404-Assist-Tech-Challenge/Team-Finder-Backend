...
def make_chat_gpt_request(data, user_id):
    ...
    system_message = (
        ...
        "Before responding, ask yourself this: have I created a full team that satisfies the project manager's requirements?"
        "If yes, return the best team. If no, return an empty list."
    )
