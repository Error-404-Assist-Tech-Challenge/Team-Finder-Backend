...
@project_tech_stack_skills_router.post("/api/projects/project_tech_stack_skills", response_model=Project_tech_stack_skills)
...
@project_tech_stack_skills_router.get("/api/projects/project_tech_stack_skills")
